...
class GPS_Fetch:
    ...
    def GPS_Info():
        ...
        lat_in_degrees = GPS_Fetch.convert_to_degrees(lat)    #get latitude in degree decimal format
        long_in_degrees = GPS_Fetch.convert_to_degrees(longi) #get longitude in degree decimal format
